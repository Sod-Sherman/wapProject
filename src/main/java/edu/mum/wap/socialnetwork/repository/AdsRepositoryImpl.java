    ...
    private AdsRepositoryImpl(){
        if(this.adsList == null)
            this.adsList = new ArrayList<Ads>(Arrays.asList(
                    new Ads(1, "Facebook", "Connect to Facebook", "http://facebook.com", 0.5, "https://en.facebookbrand.com/wp-content/uploads/2019/04/f_logo_RGB-Hex-Blue_512.png"),
                    new Ads(2,"Twitter", "Connect to Twitter", "http://twitter.com", 0.25, "https://postcron.com/en/blog/wp-content/uploads/2017/01/social-media-image-sizes-2019-min.png")
            ));
    }
